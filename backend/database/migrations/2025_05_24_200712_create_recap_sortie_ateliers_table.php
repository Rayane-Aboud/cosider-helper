<?php
     ...
     class CreateRecapSortieAteliersTable extends Migration
     {
         public function up()
         {
             Schema::create('recap_sortie_ateliers', function (Blueprint $table) {
                 $table->id();
                 $table->string('mois');
                 $table->string('pole');
         ...
         {
             Schema::dropIfExists('recap_sortie_ateliers');
         }
     }